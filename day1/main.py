...
def part_2_v1():
    for num in DATA:
        for second_number in DATA:
            for third_number in DATA:
                if num + second_number + third_number == 2020:
                    return num * second_number * third_number


def part_2_v2():
    for num in DATA:
        for second_number in DATA:
            if 2020 - (num + second_number) in DATA:
                return num * second_number * (2020 - (num + second_number))
